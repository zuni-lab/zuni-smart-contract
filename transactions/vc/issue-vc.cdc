...
transaction(issuerDID: String, id: String, holderDID: String) {
    ...
    execute {
        ...
        vcVaultAuthRef.issueRevocableVC(issuerAddress: self.issuerAddress, issuerDID: removedPrefixDID, id: id, holderDID: holderDID)
